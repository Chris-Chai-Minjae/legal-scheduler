...
# Google OAuth2 authentication [https://github.com/zquestz/omniauth-google-oauth2]
...
# Image manipulation for watermark feature
gem "mini_magick"

# PDF manipulation for watermark feature
gem "combine_pdf"
gem "prawn"
